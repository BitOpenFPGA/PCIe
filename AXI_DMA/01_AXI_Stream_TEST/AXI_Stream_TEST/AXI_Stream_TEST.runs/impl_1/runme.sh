...
HD_PWD='F:/FILE/FPGA/ZYNQ/PCIe/01_AXI_Stream_TEST/AXI_Stream_TEST/AXI_Stream_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_stream_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_stream_v1.tcl -notrace
