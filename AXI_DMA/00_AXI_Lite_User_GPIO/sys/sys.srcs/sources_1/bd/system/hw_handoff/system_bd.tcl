...
proc create_root_design { parentCell } {
  ...
  # Create instance: GPIO_LITE_ML_0, and set properties
  set GPIO_LITE_ML_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:GPIO_LITE_ML:1.0 GPIO_LITE_ML_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins GPIO_LITE_ML_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins math_ip_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ps7_0_axi_periph_M01_AXI]
  ...
  connect_bd_net -net GPIO_LITE_ML_0_GPIO_LED [get_bd_ports GPIO_LED] [get_bd_pins GPIO_LITE_ML_0/GPIO_LED] [get_bd_pins ila_0/probe0]
  connect_bd_net -net math_ip_0_result [get_bd_pins math_ip_0/result] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins GPIO_LITE_ML_0/s00_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins math_ip_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins GPIO_LITE_ML_0/s00_axi_aresetn] [get_bd_pins math_ip_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GPIO_LITE_ML_0/s00_axi/reg0] SEG_GPIO_LITE_ML_0_reg0
