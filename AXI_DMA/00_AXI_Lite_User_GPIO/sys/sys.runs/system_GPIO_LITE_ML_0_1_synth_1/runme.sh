...
HD_PWD='F:/FILE/FPGA/ZYNQ/PCIe/00_AXI_Lite_User_GPIO/sys/sys.runs/system_GPIO_LITE_ML_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_GPIO_LITE_ML_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_GPIO_LITE_ML_0_1.tcl
