...
HD_PWD='F:/FILE/FPGA/ZYNQ/PCIe/01_AXI_Stream_TEST/AXI_Stream_TEST/AXI_Stream_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_stream_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_stream_v1.tcl
